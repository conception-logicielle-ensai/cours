...
### **Remarque importante**  
Les conteneurs reposent sur le noyau de l'hôte pour leur mécanisme d'isolation des processus. Cela signifie qu'ils n'ont pas de noyau propre, ce qui les rend plus légers que les machines virtuelles. Cela permet également une gestion plus rapide et plus efficace des ressources.
